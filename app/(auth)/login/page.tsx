...
function LoginInner() {
  ...
  const callbackUrl = search?.get("callbackUrl") || "/"; // respeta ?callbackUrl
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await signIn("credentials", {
        ...
        password,
        redirect: true,
        callbackUrl, // usa la url de retorno si vino en query
      });
    } finally {
      setSubmitting(false);
    }
...
/* Página: envuelve LoginInner en Suspense (requerido por useSearchParams) */
